...
var SimpleList = function (_a) {
    ...
    return (React.createElement("div", { className: "dashboard__list-container" },
        React.createElement("div", { className: "dashboard__list-section-title" },
            React.createElement("h4", null, title),
            React.createElement("hr", { className: "base__hr-right-ease" })),
        React.createElement("div", { className: "dashboard__list-section-items" }, items.map(function (item, index) { return (React.createElement("div", { key: index },
            React.createElement("div", { className: "dashboard__list-item" },
                React.createElement("div", { className: "dashboard__list-name" },
                    iconA,
                    React.createElement("p", null, item.name)),
                React.createElement("div", { className: "dashboard__list-date" },
                    React.createElement("p", null,
                        "Creado el ",
                        item.date))),
            React.createElement("hr", { className: "base__hr-right-left-ease" }))); }))));
};
